...
public class RecipientStatusService {
    ...
    public String getRecipientStatus(Integer recId, String userMessage) {
        try {
            // 1. 현재 recId로 노약자 정보 조회하여 custId 얻기
            ...
            log.error("노약자 상태 조회 실패", e);
            return "노약자 상태를 조회하는 중 문제가 발생했어요.";
        }
    }
}
